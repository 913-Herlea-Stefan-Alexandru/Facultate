...
#include <memory>
#include "../../../../Lecture_9/introspection/MyClass.h"
...
QT_MOC_LITERAL(1, 8, 8), // "myMethod"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 1), // "x"
QT_MOC_LITERAL(4, 20, 6) // "parent"

    },
    "MyClass\0myMethod\0\0x\0parent"
};
...
void MyClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::CreateInstance) {
        switch (_id) {
        case 0: { MyClass *_r = new MyClass((*reinterpret_cast< QObject*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        case 1: { MyClass *_r = new MyClass();
            if (_a[0]) *reinterpret_cast<QObject**>(_a[0]) = _r; } break;
        default: break;
        }
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->myMethod((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
