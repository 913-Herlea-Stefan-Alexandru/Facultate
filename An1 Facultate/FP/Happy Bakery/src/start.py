...
2. What do I start with (according to simple feature-driven development)
    ...
    Lecture 8 - Service and other shiny new things
        1. Repository - at least 2 valid options
            a. Create a Repo class for each entity (IngredientRepo, ProductRepo etc.)
            ...
            b. Create a single, generic Repository class
                ...
                Let's set the constraint that each entity has a unique id (uses the id property)
