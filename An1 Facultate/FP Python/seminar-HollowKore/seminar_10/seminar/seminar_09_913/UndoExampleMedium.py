...
from seminar.seminar_09_913.repository.ClientTextRepo import ClientTextFileRepo
from seminar.seminar_09_913.repository.CarTextRepo import CarTextFileRepo
from seminar.seminar_09_913.repository.RentalTextRepo import RentalTextFileRepo


def undo_example_medium():
    undo_service = UndoService()
    client_repo = ClientTextFileRepo()
    car_repo = CarTextFileRepo()

    '''
    Start rental Controller
    '''
    rent_repo = RentalTextFileRepo(client_repo, car_repo)
