...
class MyTestCase(unittest.TestCase):
    def test_student(self):
        ...
        self.assertEqual(student.student_id == '12345' and student.name == 'Gabi George', True)
    ...
    def test_discipline(self):
        ...
        self.assertEqual(discipline.discipline_id == '5356' and discipline.name == 'Math', True)
        discipline.name = 'FP'
    ...
    def test_add_student(self):
        ...
        sv = Service(st_repo, DisciplineRepository(), GradeRepository(), Validation(), UndoService())
    ...
    def test_remove_student(self):
        st_repo = StudentRepository()
        gr_repo = GradeRepository()
        sv = Service(st_repo, DisciplineRepository(), gr_repo, Validation(), UndoService())
        sv.add_student('12345', 'Dan')
        sv.add_student('13467', 'Bob')
        sv.add_discipline('12345', 'Math')
        sv.add_grade('12345', '12345', '8')
    ...
    def test_list_all_students(self):
        ...
        self.assertEqual(student_list[0].student_id == '12345' and student_list[1].student_id == '13467', True)
    ...
    def test_add_discipline(self):
        dc_repo = DisciplineRepository()
        sv = Service(StudentRepository(), dc_repo, GradeRepository(), Validation(), UndoService())
        sv.add_discipline('12345', 'Math')
    ...
    def test_list_all_disciplines(self):
        ...
        self.assertEqual(discipline_list[0].discipline_id == '12345' and discipline_list[1].discipline_id == '34567', True)

    def test_remove_discipline(self):
        dc_repo = DisciplineRepository()
        gr_repo = GradeRepository()
        sv = Service(StudentRepository(), dc_repo, gr_repo, Validation(), UndoService())
        sv.add_discipline('12345', 'Math')
        sv.add_discipline('34567', 'FP')
        sv.add_student('12345', 'Dan')
        sv.add_grade('12345', '12345', '10')
    ...
    def test_add_grade(self):
        ...
        sv.add_discipline('12345', 'Math')
        sv.add_discipline('34567', 'FP')
        sv.add_grade('12345', '13467', '10')
        self.assertEqual(len(gr_repo) == 1, True)
        try:
            sv.add_grade('25235', '32425', '10')
            self.assertEqual(False, True)
        except ValidationError:
            self.assertEqual(True, True)
    ...
    def test_search_students(self):
        ...
        self.assertEqual(found_list[0].student_id == '12345' and found_list[1].student_id == '13467'
                         and len(found_list) == 2, True)
        try:
            sv.search_students('99')
            self.assertEqual(False, True)
        except ValidationError:
            self.assertEqual(True, True)
    ...
    def test_search_disciplines(self):
        ...
        self.assertEqual(found_list[0].discipline_id == '12345' and found_list[1].discipline_id == '13467'
                         and len(found_list) == 2, True)
        try:
            sv.search_disciplines('99')
            self.assertEqual(False, True)
        except ValidationError:
            self.assertEqual(True, True)
    ...
    def test_failing_students(self):
        ...
        sv.add_discipline('34567', 'FP')
        sv.add_grade('12345', '13467', '10')
        sv.add_grade('12345', '12345', '4')
        sv.add_grade('12345', '12345', '5')
        sv.add_grade('34567', '12345', '3')
        sv.add_grade('12345', '54321', '7')
        sv.add_grade('12345', '54321', '5')
        sv.add_grade('34567', '54321', '2')
    ...
    def test_top_disciplines(self):
        ...
        self.assertEqual(disc_top[0].discipline.name == 'Math' and disc_top[1].discipline.name == 'FP', True)
        for d_t in disc_top:
            try:
                str(d_t)
                self.assertEqual(True, True)
...
def test_init(student_repo, discipline_repo, grade_repo):
    ...
    while i < 10:
        ...
        grade_repo.add(Grade(discipline_id, student_id, str(grade_value)))
        i += 1
...
def test2_init(student_repo, discipline_repo, grade_repo):
    ...
    grade_repo.add(Grade('11111', '11111', 8))
    grade_repo.add(Grade('22222', '22222', 5))
    grade_repo.add(Grade('33333', '33333', 6))
    grade_repo.add(Grade('44444', '44444', 9))
    grade_repo.add(Grade('55555', '55555', 10))
    grade_repo.add(Grade('66666', '66666', 4))
    grade_repo.add(Grade('77777', '77777', 3))
    grade_repo.add(Grade('88888', '88888', 4))
    grade_repo.add(Grade('99999', '99999', 2))
    grade_repo.add(Grade('12345', '12345', 7))
    grade_repo.add(Grade('22222', '11111', 10))
    grade_repo.add(Grade('33333', '22222', 9))
    grade_repo.add(Grade('44444', '33333', 6))
    grade_repo.add(Grade('55555', '44444', 5))
    grade_repo.add(Grade('66666', '55555', 7))
    grade_repo.add(Grade('77777', '66666', 3))
    grade_repo.add(Grade('88888', '77777', 6))
    grade_repo.add(Grade('99999', '88888', 9))
    grade_repo.add(Grade('12345', '99999', 10))
    grade_repo.add(Grade('11111', '12345', 2))
