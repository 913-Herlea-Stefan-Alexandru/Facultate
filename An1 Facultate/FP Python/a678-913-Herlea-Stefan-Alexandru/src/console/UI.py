...
class MenuUI:
    ...
    def _write_student(self, student):
        return 'id: ' + student.student_id + ' Name: ' + student.name.ljust(10)

    def _write_discipline(self, discipline):
        return 'id: ' + discipline.discipline_id + ' Discipline: ' + discipline.name.ljust(12)

    def _write_grade(self, grade):
        return 'Discipline id: ' + grade.discipline_id + ' Student id: ' + grade.student_id + ' Grade: ' \
               + str(grade.grade_value).ljust(2)
