...
class Service:
    ...
    def add_grade(self, discipline_id, student_id, grade_value):
        ...
        discipline = self._discipline_repo[discipline_id]
        student = self._student_repo[student_id]
        grade = Grade(discipline.discipline_id, student.student_id, grade_value)
    ...
    def find_grades_discipline_student(self, discipline_id, student_id):
        return self._grade_repo[discipline_id+student_id]
    ...
    def list_all_grades(self):
        ...
        '''
        grade_list = self._grade_repo.grade_list
        return grade_list
    ...
    def search_students(self, search_str):
        ...
        '''
        return self._student_repo.search(search_str)
    ...
    def search_disciplines(self, search_str):
        ...
        '''
        return self._discipline_repo.search(search_str)
