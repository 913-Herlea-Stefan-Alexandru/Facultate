...
class DisciplineRepository:
    ...
    def add(self, discipline):
        ...
        '''
        if discipline.discipline_id in [disc.discipline_id for disc in self._discipline_list]:
    ...
    def __getitem__(self, given_id):
        ...
        '''
        if not (given_id in [disc.discipline_id for disc in self._discipline_list]):
            raise ValidationError('\nDiscipline with given id not found\n')
        for discipline in self._discipline_list:
            if discipline.discipline_id == given_id:
                return discipline
    ...
    def get_id_list(self):
        return [discipline.discipline_id for discipline in self._discipline_list]
    ...
    def search(self, search_str):
        ...
        found_list = []
        for discipline in self._discipline_list:
            if search_str.lower() in discipline.discipline_id or search_str.lower() in discipline.name.lower():
