...
class StudentRepository:
    ...
    def add(self, student):
        ...
        '''
        if student.student_id in [stud.student_id for stud in self._student_list]:
    ...
    def __getitem__(self, given_id):
        ...
        '''
        if not (given_id in [stud.student_id for stud in self._student_list]):
            raise ValidationError('\nStudent with given id not found\n')
        for student in self._student_list:
            if student.student_id == given_id:
                return student
    ...
    def get_id_list(self):
        return [student.student_id for student in self._student_list]
    ...
    def search(self, search_str):
        ...
        found_list = []
        for student in self._student_list:
            if search_str.lower() in student.student_id or search_str.lower() in student.name.lower():
