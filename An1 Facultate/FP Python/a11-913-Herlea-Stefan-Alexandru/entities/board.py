        ...
        if pgame:
            ...
            for i in range(self._size):
                for j in range(self._size):
                    m = i + j
                    if m % 2 == 0:
                        self.tile_list.append(Tile("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\light_tile.png", 50, x + j * 50, y + i * 50))
                    else:
                        self.tile_list.append(Tile("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\dark_tile.png", 50, x + j * 50, y + i * 50))
    ...
    def move(self, letter, number):
        ...
        if self._grid[y][x] == 0:
            ...
            if self._pgame:
                for tile in self.tile_list:
                    if tile.rect.x == self.rect.x + x * 50 and tile.rect.y == self.rect.y + y * 50:
                        tile.change_picture("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\light_tile_miss.png")
            ...
            if self._pgame:
                for tile in self.tile_list:
                    if tile.rect.x == self.rect.x + x * 50 and tile.rect.y == self.rect.y + y * 50:
                        tile.change_picture("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\damaged_tile.png")
                        self.image.blit(tile.image, (50 * x, 50 * y))
                        break
