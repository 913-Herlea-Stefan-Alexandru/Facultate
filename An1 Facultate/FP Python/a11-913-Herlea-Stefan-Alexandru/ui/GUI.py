...
class GUI:
    ...
    def on_init(self):
        ...
        self._background = pygame.image.load("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\\background.jpg")
        ...
        pygame.mixer.init()
        pygame.mixer.music.load("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\wave_sounds.mp3")
        pygame.mixer.music.play(-1, 0.0)

        self._splash = pygame.mixer.Sound("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\splash.mp3")
        self._explosion = pygame.mixer.Sound("F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\explosion.mp3")
