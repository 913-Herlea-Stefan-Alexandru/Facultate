...
class SmartAi:
    def __init__(self, pgame = False):
        self._carrier = Battleship(5, 'carrier', "F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\carrier.png", x=50,
                                   y=625, pgame=pgame)
        self._battleship = Battleship(4, 'battleship',
                                      "F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\\battleship.png", x=325,
                                      y=625, pgame=pgame)
        self._cruiser = Battleship(3, 'cruiser', "F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\cruiser.png", x=50,
                                   y=550, pgame=pgame)
        self._submarine = Battleship(3, 'submarine', "F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\submarine.png",
                                     x=225, y=550, pgame=pgame)
        self._destroyer = Battleship(2, 'destroyer', "F:\An1 Facultate\FP Python\\a11-913-Herlea-Stefan-Alexandru\\res\destroyer.png",
